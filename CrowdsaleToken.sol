...
contract CrowdsaleToken is StandardToken {
    ...
    string public constant name = "AkayCoin";
    string public constant symbol = "AK";
    uint8 public constant decimals = 18;
    
    // address where funds are collected
    address public constant wallet = 0xed8862bcb2a3186f6123ed924dbb4cfc5a747491;
    ...
    function createTokens(address recipient) payable {
        ...
        uint tokens = (msg.value.mul(getPrice())).div(1 ether);
    ...
    //Returns the total amount of tokens per ether.
